...
export const CLASSIC: ClassicEntry[] = [
  ...
  // spot-checked the physics/chemistry shelf (already deep — Newton,
  // Einstein, Bohr, Heisenberg, Dirac, Schrödinger, Maxwell, Boyle,
  // Lavoisier, Mendeleev) against a list of major names outside fiction's
  // usual orbit and found three genuine total-absence gaps, each closing a
  // distinct thematic hole rather than duplicating coverage already here.
  // All three WebSearch-verified (Curie's 1903 Sorbonne thesis / 1904
  // English publication; Faraday's 1839/1844/1855 three-volume span;
  // Boltzmann's 1896/1898 two-part Vorlesungen) and collision-checked
  // (grepped classic.ts and must-read.ts for all three titles, all aka
  // spellings, and all three authors' surnames — zero hits before writing).
  { title: "Radioactive Substances", author: "Marie Curie", why: "Marie Curie's doctoral thesis, defended at the Sorbonne in 1903 — the first doctorate awarded to a woman in France — and published in English translation as a book in 1904. Coined the term \"radioactivity\" itself, proved it to be an atomic (not chemical or molecular) property shared across elements, and documented the isolation of polonium and radium. Curie went on to become the first person ever awarded two Nobel Prizes, in two different sciences (Physics 1903, Chemistry 1911). This list's physics/chemistry shelf runs Newton, Maxwell, Boltzmann, Boyle, Lavoisier, and the full quantum-mechanics founders (Bohr, Heisenberg, Dirac, Schrödinger) — every one of them a man, and none addressing radioactivity, the discovery that opened the door to nuclear physics those later entries build on.", aka: ["Radio-active Substances", "Recherches sur les substances radioactives"] },
  { title: "Experimental Researches in Electricity", author: "Michael Faraday", why: "Collected across three volumes published in 1839, 1844, and 1855, gathering the 29 numbered \"series\" of papers Faraday read to the Royal Society between 1831 and 1852 — the record of the experiments that discovered electromagnetic induction, established the laws of electrolysis, and introduced the field concept later generations would call \"lines of force.\" Faraday had no formal mathematical training and worked entirely by careful, patient experiment; it was Maxwell, already here via A Treatise on Electricity and Magnetism, who took Faraday's field concept and gave it its full mathematical form three decades later. Where Maxwell's Treatise is the theory, this is the experimental foundation the theory was built to explain — closes a gap in a shelf that otherwise jumps straight from Newton's mechanics to Maxwell's completed electromagnetism with nothing on how electromagnetism was actually discovered." },
  { title: "Lectures on Gas Theory", author: "Ludwig Boltzmann", why: "Published in two parts as Vorlesungen über Gastheorie (1896, 1898), the definitive statement of the statistical-mechanical view of heat: that temperature and pressure are nothing but the aggregate statistics of vast numbers of colliding molecules, and that entropy itself is a measure of probability, formalized in the equation (S = k log W) engraved on Boltzmann's own tombstone. Fiercely disputed in his lifetime by physicists who still doubted atoms were real, a dispute Boltzmann did not live to see resolved — he died in 1906, a few years before Einstein's 1905 paper on Brownian motion supplied the decisive experimental confirmation. This list's physics shelf covers classical mechanics (Newton), electromagnetism (Faraday, Maxwell), relativity (Einstein), and quantum theory (Bohr, Heisenberg, Dirac, Schrödinger) — statistical mechanics, the bridge between them and thermodynamics, had no representation at all.", aka: ["Vorlesungen über Gastheorie", "Vorlesungen ueber Gastheorie"] },

  // Round 97 (2026-09-21, daily-must-read-and-classic task): continued the
  // gap-scan against the medicine shelf (anatomy/Vesalius,
  // physiology/Harvey, epidemiology/Snow, immunology/Jenner, genetics/
  // Mendel all present) and found germ theory and bacteriology itself --
  // the causal mechanism epidemiology and immunology both work around
  // without ever naming -- totally absent (zero hits for Pasteur, Koch,
  // "germ theory", "bacteria", "microbiology" across both files before
  // writing). Also closed round 95's twice-flagged, still-open meteorology
  // gap. All three WebSearch-verified (Pasteur's 30 April 1878 Academy of
  // Medicine lecture and its direct influence on Lister's antisepsis;
  // Koch's 24 March 1882 Berlin Physiological Society presentation, the
  // Koch's-postulates methodology, and his 1905 Nobel Prize; Howard's
  // December 1802 Askesian Society lecture, 1803 publication, and explicit
  // debt to Linnaeus's nomenclature) and collision-checked (grepped both
  // files for all three titles, all aka spellings, both authors' surnames,
  // and "Luke Howard"/"Askesian" -- zero hits before writing).
  { title: "The Germ Theory and Its Applications to Medicine and Surgery", author: "Louis Pasteur", why: "Delivered to the French Academy of Medicine on 30 April 1878 in Pasteur's own name and that of collaborators Joubert and Chamberland, the lecture that turned germ theory from a disputed hypothesis into settled medical doctrine — arguing, against a medical establishment still largely wedded to spontaneous generation and miasma, that specific microorganisms cause specific diseases and can be tracked, cultured, and killed. Joseph Lister read the published lecture and used it to justify doubling down on carbolic-acid antisepsis in his own wards against his own critics, driving surgical infection rates down within years. This list's medicine shelf runs anatomy (Vesalius), physiology (Harvey), epidemiology (Snow), and immunology (Jenner) — every one of them describing, mapping, or empirically defeating disease without ever naming the causal agent behind it; this is the lecture that named it.", aka: ["La théorie des germes et ses applications à la médecine et à la chirurgie", "Germ Theory and Its Applications to Medicine and Surgery"] },
  { title: "The Aetiology of Tuberculosis", author: "Robert Koch", why: "Presented to the Berlin Physiological Society on 24 March 1882 and published the same year, the paper identifying Mycobacterium tuberculosis as the specific cause of a disease then killing roughly one in seven people across Europe — and, more consequentially, setting out what became known as Koch's postulates: the organism must be found in every case of the disease, isolated in pure culture, and reproduce the disease when introduced into a healthy host. Where Pasteur's germ theory lecture, already here, established that specific microbes cause specific diseases in general, Koch's postulates gave that claim a testable method, still the baseline standard for proving a microorganism causes a disease. Won Koch the 1905 Nobel Prize in Physiology or Medicine and founded bacteriology as a rigorous, replicable discipline rather than a set of suggestive observations.", aka: ["Die Ätiologie der Tuberkulose", "Die Aetiologie der Tuberkulose", "The Etiology of Tuberculosis"] },
  { title: "On the Modification of Clouds", author: "Luke Howard", why: "Read to London's Askesian Society in December 1802 and published in 1803 by a working pharmacist with no formal scientific training, proposing — explicitly modeled on the binomial nomenclature of Linnaeus's Systema Naturae, already on this list — a Latin classification for cloud shapes: cirrus, cumulus, stratus, and nimbus, with compound forms like cirrostratus and cumulonimbus describing the transitions between them. Adopted across Western Europe within a decade and still, essentially unchanged, the classification system meteorologists use today; Goethe wrote a poem in Howard's honor, and Turner and Constable both credited it with sharpening how they painted skies. Closes this list's total absence of meteorology as a discipline of its own, flagged and left open across the last two rounds, distinct from its nearest earth-science neighbors oceanography (Maury) and cartography (Ptolemy), both already here.", aka: ["Essay on the Modification of Clouds", "Essay on the Modifications of Clouds", "On the Modifications of Clouds"] },

  // Round 98 (2026-09-22, daily_novel_viz_feat / search-bar-to-viz task):
  // this list's law shelf runs domestic/municipal law deep -- Blackstone's
  // common law, Hart's legal philosophy, Beccaria's criminal law, Locke and
  // Montesquieu's political theory -- but had zero representation of law
  // *between* states, the body of doctrine governing war, peace, treaties,
  // and sovereignty itself. Separately, the geopolitics shelf ran
  // Mackinder's land-power Heartland Theory (round 88) with no counterpart
  // from the sea-power school that shaped the exact same pre-WWI arms race
  // from the opposite theoretical direction -- a natural pairing left half
  // finished. Both total-absence gaps (zero hits for "Grotius"/"De Jure
  // Belli"/"Law of War and Peace" and "Mahan"/"Sea Power" across both files
  // before writing), both WebSearch-verified (Grotius's De Jure Belli ac
  // Pacis, written in Loevestein prison and published in Paris in 1625,
  // and its standing -- contested with Gentili and Suárez, noted honestly
  // below rather than overclaimed -- as international law's founding text;
  // Mahan's The Influence of Sea Power upon History, 1660-1783, published
  // by Little, Brown and Co. in 1890 while Mahan was president of the US
  // Naval War College, and its direct influence on the pre-WWI naval
  // buildup).
